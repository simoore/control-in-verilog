...
class TestLtiSystem(unittest.TestCase):
    ...
    def test_gramians(self):
        ...
        cWc = np.array([[6.999969e-01, 1.114907e-05, 2.368522e-06, -1.562850e-06],
        ...
        cWo = np.array([[6.999969e-01, -1.114907e-05, 2.368522e-06, 1.562850e-06],
                        [-1.114907e-05, 2.353370e-01, 2.539451e-06, 6.104784e-07],
                        [2.368522e-06, 2.539451e-06, 3.775594e-02, -2.332329e-07],
                        [1.562850e-06, 6.104784e-07, -2.332329e-07, 2.452912e-03]])
        ...
        dWc = np.array([[5.696589e-09, 9.073142e-14, 1.927509e-14, -1.271850e-14],
        ...
        dWo = np.array([[8.601562e+07, -1.369998e+03, 2.910440e+02, 1.920430e+02],
